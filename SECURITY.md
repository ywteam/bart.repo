...
* [{{ teams.security.email }}](mailto:{{ teams.security.email }})
...
Please report (suspected) security vulnerabilities to **[{{ teams.security.email }}](mailto:{{ teams.security.email }})**. You will receive a response from
...
We recommend the following best practices to ensure the security of your application:
- Regularly update dependencies to avoid known vulnerabilities.
- Use environment variables to manage sensitive information.

Thank you for helping to keep the `{{ repo.name }}` secure!
