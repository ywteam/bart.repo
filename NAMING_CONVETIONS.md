...
- `core` - changes to the core / private API / backend of {{ .repo.name }}
...
> 💡 The breaking changes must also be added to the [packages/cli/BREAKING-CHANGES.md](https://github.com/{{ .repo.name }}-io/{{ .repo.name }}/blob/master/packages/cli/BREAKING-CHANGES.md) file located in the {{ .repo.name }} repository.
